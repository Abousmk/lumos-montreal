...
function SocialGlyph({ id }) {
  switch (id) {
    ...
    case 'tiktok':
      return (
        <svg {...socialSvgProps}>
          <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64v-3.4a6.21 6.21 0 00-1-.1 6.36 6.36 0 100 12.72 6.36 6.36 0 006.27-5.51v-7a8.16 8.16 0 004.77 1.52v-3.4a4.85 4.85 0 01-1-.93z" />
        </svg>
      )
    case 'x':
      return (
